...
void initPrimitives(){
	cubeshape = new elementManager(std::make_shared<std::vector<vertex>>(std::vector<vertex>{
	...
	planeshape = new elementManager(std::make_shared<std::vector<vertex>>(std::vector<vertex>{
